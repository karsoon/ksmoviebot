...
const mdb = require('moviedb')('f2c9d2abb97baba10c1da21a66e09018');
...
const connector = new builder.ChatConnector({
  appId: '581e2336-59c1-4173-8bdb-48add1bed80b',
  appPassword: 'OY28MP3ZOYtHXZdFypGr2Qb',
});
const bot = new builder.UniversalBot(connector);
server.post('/api/messages', connector.listen());

const luisUrl = 'api.projectoxford.ai/luis/v1';
const luisModelUrl = `https://${luisUrl}/application?id=${'7d681412-c691-454c-8833-81eb911ebfa2'}&subscription-key=${'18591673e7614720a747895ed847983f'}`;
